...
def move(board)
  ...
  if @game_mode == 'wrapped'
    ...
    @score_multiplier = {
      ...
      'hazard' => -550,
      'hazard_adjacent' => 0,
      'food' => 85,  # Increased from 55 - more attractive
      'food_hazard' => 0,
      ...
      'other_snake_head' => -2,
      'other_snake_body' => -90,  # Increased penalty from -30 - more conservative
    ...
    @score_multiplier = {
      ...
      'food' => 35,  # Increased from 15 - more attractive
      'food_hazard' => 2,
      ...
      'other_snake_head' => -2,
      'other_snake_body' => -225,  # Increased penalty from -130
